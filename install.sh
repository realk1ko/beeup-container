...
echo Do you want to download the actual version of Bee-up? \[yes\|no\]
read input

if [[ $input == 'yes' ]]; then
  echo "Bee-Up 1.6 is getting downloaded and moved to the right directory.."
	wget https://bee-up.omilab.org/files/tool-installer/Bee-Up_1.6_64-bit_macOS-prototype.zip
	unzip Bee-Up_1.6_64-bit_macOS-prototype.zip
	mv bee-up-master-TOOL/TOOL home/app/beeup
	rm Bee-Up_1.6_64-bit_macOS-prototype.zip
	rm -r bee-up-master-TOOL
else
	echo "Installer expects that you've downloaded Bee-up by yourself and moved it to home/app/beeup"   
fi

if [[ `uname -m` == 'arm64' ]]; then
	echo "Recognized Apple Silicon CPU"
        sudo docker build -f Dockerfile_M1 --platform linux/amd64 . -t beeup:latest
...
echo "============================================================"
	...
	echo "Recognized Intel CPU. Continuing.."
